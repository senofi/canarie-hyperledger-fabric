...
if [ "$CC_SRC_LANGUAGE" = "go" ]; then
  ...
  #C_SRC_PATH=$CC_SRC_PATH/build/install/$CC_NAME
...
## Install chaincode on peer0.nova and peer0.genh
infoln "Installing chaincode on peer0.nova..."
installChaincode 1
...
## approve the definition for nova
approveForMyOrg 1
